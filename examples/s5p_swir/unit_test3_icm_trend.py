...
def main():
    ...
    icm_mon_db = 'offsdark/beta-nominal/mon_darkflux_beta-nominal'

    orbit_bgn = 1867
    orbit = 21952

    with ICMmonStability(data_dir + icm_mon_db) as mon:
        stats = trend_stats(mon, orbit_bgn, orbit, ['diff_ckd'])
        stats['diff_ckd'].values /= 579.60
        stats['diff_ckd'].attrs['long_name'] = 'deviation'
        stats['diff_ckd'].attrs['units'] = '%'
    ...
    title = f'trend of detector median & temperatures'
